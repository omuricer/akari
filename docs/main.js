...
// EXTERNAL MODULE: ./src/sass/common.scss
...
var topAppBarElement = document.querySelector(".mdc-top-app-bar"); // const topAppBar = new MDCTopAppBar(topAppBarElement);

var src_swiper = new swiper_esm_bundle('.swiper-container', {
  effect: 'fade',
  loop: true,
  speed: 700,
  navigation: {
